...
// Apiv1GenericVirtualAccountData apiv1 generic virtual account data
//
// swagger:model apiv1.GenericVirtualAccountData
type Apiv1GenericVirtualAccountData struct {
...
// Validate validates this apiv1 generic virtual account data
func (m *Apiv1GenericVirtualAccountData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Apiv1GenericVirtualAccountData) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *Apiv1GenericVirtualAccountData) validateTotalAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this apiv1 generic virtual account data based on the context it is used
func (m *Apiv1GenericVirtualAccountData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Apiv1GenericVirtualAccountData) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Apiv1GenericVirtualAccountData) contextValidateTotalAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Apiv1GenericVirtualAccountData) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Apiv1GenericVirtualAccountData) UnmarshalBinary(b []byte) error {
	var res Apiv1GenericVirtualAccountData
