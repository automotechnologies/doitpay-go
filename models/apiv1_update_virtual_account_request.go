...
// Apiv1UpdateVirtualAccountRequest apiv1 update virtual account request
//
// swagger:model apiv1.UpdateVirtualAccountRequest
type Apiv1UpdateVirtualAccountRequest struct {
...
// Validate validates this apiv1 update virtual account request
func (m *Apiv1UpdateVirtualAccountRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Apiv1UpdateVirtualAccountRequest) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *Apiv1UpdateVirtualAccountRequest) validateTotalAmount(formats strfmt.Registry) error {
...
// ContextValidate validate this apiv1 update virtual account request based on the context it is used
func (m *Apiv1UpdateVirtualAccountRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Apiv1UpdateVirtualAccountRequest) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Apiv1UpdateVirtualAccountRequest) contextValidateTotalAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Apiv1UpdateVirtualAccountRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Apiv1UpdateVirtualAccountRequest) UnmarshalBinary(b []byte) error {
	var res Apiv1UpdateVirtualAccountRequest
