...
func (m *DeleteVirtualAccountResponse) validateVirtualAccountData(formats strfmt.Registry) error {
...
func (m *DeleteVirtualAccountResponse) contextValidateVirtualAccountData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteVirtualAccountResponse) UnmarshalBinary(b []byte) error {
	var res DeleteVirtualAccountResponse
