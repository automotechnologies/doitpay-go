...
func (m *UpdateVirtualAccountRequest) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *UpdateVirtualAccountRequest) validateTotalAmount(formats strfmt.Registry) error {
...
func (m *UpdateVirtualAccountRequest) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateVirtualAccountRequest) contextValidateTotalAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateVirtualAccountRequest) UnmarshalBinary(b []byte) error {
	var res UpdateVirtualAccountRequest
