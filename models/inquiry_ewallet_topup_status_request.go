...
func (m *InquiryEwalletTopupStatusRequest) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *InquiryEwalletTopupStatusRequest) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InquiryEwalletTopupStatusRequest) UnmarshalBinary(b []byte) error {
	var res InquiryEwalletTopupStatusRequest
