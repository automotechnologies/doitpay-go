...
func (m *InquiryVirtualAccountResponse) validateVirtualAccountData(formats strfmt.Registry) error {
...
func (m *InquiryVirtualAccountResponse) contextValidateVirtualAccountData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InquiryVirtualAccountResponse) UnmarshalBinary(b []byte) error {
	var res InquiryVirtualAccountResponse
