...
func (m *QrisRequestScheme) validateAmount(formats strfmt.Registry) error {
...
func (m *QrisRequestScheme) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
