...
func (m *InquiryDisbursementStatusRequest) validateAdditionalInfo(formats strfmt.Registry) error {
...
func (m *InquiryDisbursementStatusRequest) contextValidateAdditionalInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InquiryDisbursementStatusRequest) UnmarshalBinary(b []byte) error {
	var res InquiryDisbursementStatusRequest
